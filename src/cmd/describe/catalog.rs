...
pub(super) fn command_catalog() -> Vec<CommandInfo> {
    vec![
        ...
        command(
            ...
            "To read current rendered RFC content. Use --history for the archive or -o json for complete structured output.",
        ...
        command(
            ...
            "To read current rendered ADR content. Use --history for the archive or -o json for complete structured output.",
        ...
        command(
            ...
            "To read rendered work item content. Structured output remains complete.",
