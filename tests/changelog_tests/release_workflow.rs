...
fn test_changelog_release_workflow() -> common::TestResult {
    ...
    let setup_commands: Vec<Vec<String>> = vec![
        ...
        work_tick_acceptance_done(&wi1, 1),
        work_move_done(&wi1),
        ...
        work_tick_acceptance_done(&wi2, 1),
        work_move_done(&wi2),
    ...
    let unreleased_commands: Vec<Vec<String>> = vec![
        ...
        work_tick_acceptance_done(&wi3, 0),
        work_tick_acceptance_done(&wi3, 1),
        work_move_done(&wi3),
        ...
        work_tick_acceptance_done(&wi4, 0),
        work_tick_acceptance_done(&wi4, 1),
        work_tick_acceptance_done(&wi4, 2),
        work_move_done(&wi4),
    ];
...
fn test_release_undo_removes_file_when_history_becomes_empty() -> common::TestResult {
    ...
    let setup = vec![
        ...
        work_tick_acceptance_done(&wi, 0),
        work_move_done(&wi),
