...
<!-- SIGNATURE: sha256:b32390ea45ba4453758da0940ba4b55cb001f3a89805700d53274f4b7f99f3e6 -->
...
Wire-layout prefixes such as `govctl.` and `case.` MUST be rejected. Every Case creation, edit, and deletion MUST validate the complete prospective project state before writing. An edit that would remove the final requirement binding MUST be rejected. Every failed creation, edit, or deletion MUST leave governed files unchanged.
