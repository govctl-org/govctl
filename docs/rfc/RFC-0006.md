...
<!-- SIGNATURE: sha256:0844a3ece15e16ec8a5845f8b459397fa3f701b1d3fc007fc8ce4b9fba92d8b7 -->
...
- note candidates that may become durable Work Item `notes` through explicit `govctl work edit <WI-ID> notes --add ...`
...
6. Loop field mutation MUST use the explicit `add LOOP-ID work WI-ID` and `remove LOOP-ID work WI-ID` shapes defined below.
