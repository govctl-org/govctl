...
<!-- SIGNATURE: sha256:44a6e1cc4be2ce8074c3d0b8da8d13366000c2916ec66deed244912c259e6f22 -->
...
The `work` field is the only user-facing field name for the loop's explicit work set. Implementations MAY accept `wi` as an alias for `work`. User-facing help SHOULD prefer `loop add LOOP-ID work WI-ID` and `loop remove LOOP-ID work WI-ID`.
